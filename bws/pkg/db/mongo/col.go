...
type ColInterface interface {
	Insert(doc any) (id primitive.ObjectID, err error)
	InsertMany(docs []any) (ids []primitive.ObjectID, err error)

	UpdateId(id primitive.ObjectID, update any) (err error)
	Update(query bson.M, update any) (err error)
	UpdateWithOptions(query bson.M, update any, opts *options.UpdateOptions) (err error)

	ReplaceId(id primitive.ObjectID, doc any) (err error)
	Replace(query bson.M, doc any) (err error)
	ReplaceWithOptions(query bson.M, doc any, opts *options.ReplaceOptions) (err error)
...
// Col's methods
func (col *Col) Insert(doc any) (id primitive.ObjectID, err error) {
...
func (col *Col) InsertMany(docs []any) (ids []primitive.ObjectID, err error) {
...
func (col *Col) UpdateId(id primitive.ObjectID, update any) (err error) {
...
func (col *Col) Update(query bson.M, update any) (err error) {
	return col.UpdateWithOptions(query, update, nil)
}

func (col *Col) UpdateWithOptions(query bson.M, update any, opts *options.UpdateOptions) (err error) {
	if opts == nil {
...
func (col *Col) ReplaceId(id primitive.ObjectID, doc any) (err error) {
	return col.Replace(bson.M{"_id": id}, doc)
}

func (col *Col) Replace(query bson.M, doc any) (err error) {
	return col.ReplaceWithOptions(query, doc, nil)
}

func (col *Col) ReplaceWithOptions(query bson.M, doc any, opts *options.ReplaceOptions) (err error) {
	if opts == nil {
...
func (col *Col) ListIndexes() (indexes []map[string]any, err error) {
